...
```json
{
  ...
  "focus": ["Production Apps", "AI in Mobile", "Commerce Systems"],
  "availability": "Open to freelance & collaboration",
  "currently_building": "ZEXO — Commerce OS"
}
```
...
| Module | Features |
|--------|----------|
| 🛒 **User App** | Browse · Cart · Checkout · Receipt Upload · Order Tracking · Real-time Chat |
| 📊 **Admin Dashboard** | Orders · Products · Categories · Users · Stock · Analytics · PDF Reports |
| 🔐 **Auth System** | Email · Google · Facebook · Role-based Routing · User Blocking |
| ⚙️ **Tech** | Flutter · Firebase · Firestore · Cloud Functions · FCM · Supabase · BLoC |
